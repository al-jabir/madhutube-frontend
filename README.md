...
- API Base URL: `http://localhost:5000/api/v1` (configurable via VITE_API_BASE_URL environment variable)
- Refresh Token URL: `http://localhost:5000/api/v1/users/refresh-token` (configurable via VITE_REFRESH_TOKEN_URL environment variable)
